...
public class FlinkWriteTest {
    ...
    public static void main(String[] args) {
        org.apcache.paimon.learning.FlinkWriteTest flinkWriteTest = new org.apcache.paimon.learning.FlinkWriteTest();
    ...
    public void testPaimonWrite() {
        ...
        tableEnv.executeSql("CREATE CATALOG hadoop_catalog WITH (\n" +
                " 'type'='paimon',\n" +
                " 'warehouse'='hdfs://localhost:9000/data/paimon/warehouse'\n" +
                ")");
